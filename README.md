...
The Basic Transport Packet Protocol Layer (BTPPL) is standardazied by [OCIT](https://www.ocit.org/en/).
BTPPL is used for the OCIT outstations protocol, for the communication of control center and field devices for traffic control.

Protocol specification: <https://www.ocit.org/en/ocit/downloads/> -> ocit-o_protocol_v3.0_d02.pdf
